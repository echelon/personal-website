...
Rust includes them directly in the theme button. Colors and visibility come from
the site's stylesheet. The build copies the upstream license into
`assets/lucide-LICENSE.txt` alongside the generated site.
